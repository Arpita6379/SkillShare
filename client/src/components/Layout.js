...
const Layout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Search Skills', href: '/search', icon: Search },
    { name: 'My Swaps', href: '/swaps', icon: MessageSquare },
    { name: 'Profile', href: '/profile', icon: User },
  ];

  const adminNavigation = [
    { name: 'Admin Dashboard', href: '/admin/announcements', icon: Shield },
    { name: 'Manage Users', href: '/admin/manage-users', icon: Users },
    { name: 'Swap Moderation', href: '/admin/swap-moderation', icon: Calendar },
    { name: 'Reports', href: '/admin/reports-dashboard', icon: BarChart3 },
  ];
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          ...
          <nav className="flex-1 space-y-1 px-2 py-4">
            {/* Only show admin links for p@p.com */}
            {isSuperAdmin ? (
              <>
